  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.onlyRight, onlyRight) &&
            const DeepCollectionEquality().equals(other.onlyTop, onlyTop) &&
            const DeepCollectionEquality()
                .equals(other.onlyBottom, onlyBottom) &&
            const DeepCollectionEquality().equals(other.onlyLeft, onlyLeft) &&
            const DeepCollectionEquality()
                .equals(other.exceptLeft, exceptLeft) &&
            const DeepCollectionEquality()
                .equals(other.exceptRight, exceptRight) &&
            const DeepCollectionEquality().equals(other.exceptTop, exceptTop) &&
            const DeepCollectionEquality()
