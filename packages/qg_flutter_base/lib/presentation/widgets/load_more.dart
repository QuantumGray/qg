...
// import 'package:qg_flutter_base/src/presentation/blocs/bloc_state.dart';
// import 'package:qg_flutter_base/src/presentation/widgets/refresh_bloc_consumer.dart';

// typedef LoadMoreCallback = Future<AsyncState> Function(BuildContext context);
...
//     final AsyncState result = await widget.onLoadMore(context);
